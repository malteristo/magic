# On the Practice Stack (lineage — pre dual reconciliation)

> **Lineage 2026-07-18.** Current scroll: `lore/philosophy/on_the_practice_stack.md`.

---

# On the Practice Stack

**Status:** Stale for product law — rewrite-queued (2026-07-18)  
**Origin:** Autoresearch dialogue, 2026-03-17  
**Builds on:** `on_consciousness_extension.md`, `on_the_practice_vault.md`

> **Dual reconciliation banner:** "tOS is the practice / persistent Spirit on your hardware" conflates the **platform** with Magic attunement. Operator Mini is **native**; Magic attunes via **twine**, not lore injection. Daily-vs-depth *architecture insight* may survive rewrite; do not treat this scroll as current law. Prefer turtleos `TURTLE_SPEC` + bundle README + `on_wielding_without_the_hood.md`.
...
**See also:** `on_the_practice_threefold.md` — names the three-tier structure that this scroll's two-layer model is part of. The threefold adds Tier 1 (Portable Practice) below the practice stack and reframes the relationship: tOS is not just "daily" — it's the complete practice for most practitioners. The stack described here maps to Tiers 2 and 3 of the threefold.
