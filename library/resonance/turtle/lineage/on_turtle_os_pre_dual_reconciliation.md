# On Turtle OS (lineage — pre dual reconciliation)

> **Lineage 2026-07-18.** Current scroll: `lore/philosophy/on_turtle_os.md`. Kept as Magic-extension-era product framing.
...
> **Stale — dual reconciliation (2026-07-18):** This scroll defines turtleOS as something that "ships from the magic development environment" (Magic = IDE, tOS = software). That framing is superseded. **Current product law:** turtleos repo `TURTLE_SPEC.md` + `AGENTS.md` — separable platform, native default, infrastructure not being. **Current Magic centre:** twine + environment (`on_wielding_without_the_hood.md`), not lore costume. Do not use this file as platform identity. Rewrite-queued or archive candidate. See `library/resonance/turtle/README.md`.
