# On the Practice Vision (lineage — pre dual reconciliation)

> **Lineage 2026-07-18.** Current scroll: `lore/philosophy/on_the_practice_vision.md`.
...
> **Dual reconciliation banner:** North star "turtleOS is the primary surface where **magic** is practiced" is Magic-extension era. turtleOS is a **neutral practice platform**; Magic is one practice that may run on it. "It's all boom" and recommend-to-someone-you-love remain useful *taste* signals — not product ontology. Prefer TURTLE_SPEC + bundle README until rewritten.
