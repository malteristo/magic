...
**Recovery:** Try LAN IP first ([redacted-lan-ip]). Restart tailscaled if persistent. Update CLAUDE.md with current Tailscale IP when it changes.
**Status:** Intermittent. Current Tailscale IP: [redacted-ts-ip].
