...
**Current:** Live model roles in `desk/turtle_env.md` / turtleos config. Routing *pattern* (smallest adequate model) may still inspire; this scroll is not law.  
...
> Do not load as operational guidance. Model lineups and “one consciousness” framing are era-bound.
