...
**Canonical law lives in the turtleOS repository only.** This file is a stub — do not duplicate or edit spec content here.
...
For Magic-attuned operational lore (consciousness extension, river topology history, calibration), see `library/resonance/turtle/lore/` — lore explains *why*; TURTLE_SPEC defines *what* the platform must do.
