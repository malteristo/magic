...
3. **Governance changes** — Changes to `MAGIC_SPEC.md`, `TURTLE_SPEC.md`, `system/`, `library/`, or practice law. Turtle may draft proposals; Mage sanction remains required where Law or durable governance changes.
