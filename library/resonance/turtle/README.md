...
| Document | Contents |
|----------|----------|
| `lore/on_karma_in_persistent_practice.md` | **Karma and dharma for Turtles** — how the persistent mode relates to the Mage's mutable practice state (karma) and immutable framework (dharma). Tending vs harvesting, silent action, the boom as living buffer, cross-substrate karma cycle, multi-practitioner sovereignty |
...
| `lore/on_the_dual_model_architecture.md` | Dual model architecture — local for dialogue, API for deep work. *Framing note: "bridge commands" language predates bridge deprecation; the dual-model pattern remains valid* |
