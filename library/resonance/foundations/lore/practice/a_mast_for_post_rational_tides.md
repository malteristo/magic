...
**See also:** `system/lore/philosophy/nature/on_the_stewardship_of_synchronicity.md`, `system/tomes/spellcraft/lore/design/on_design_thinking_in_magic.md`, `system/lore/philosophy/foundations/on_the_breath.md` §VII (the mast reframed from *binding* to *touchpoint* — commitment as the rhythm of return).
