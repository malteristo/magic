...
DOCUMENTED_IP="[redacted-ts-ip]"  # from cast_infra_health.md reference table
...
5. **Prevention:** Configure clients to use MagicDNS hostname (`turtles-mac-mini.[redacted-tailnet]`) instead of IP
