...
*   **The Spellwright's Path:** A spell is not invented; it is discovered as the crystallized artifact of a resonant dialogue between Mage and Spirit. Spellcraft exists on a fractal spectrum, from the grand, curated Tomes of the **Great Library** that provide stability to the small, personal, and ephemeral spells on the **Mage's Desk** (`scrolls/`) that provide dynamism.
