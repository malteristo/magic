...
*   **`system/` directory:** Contains the foundational components of the Magic framework.
    *   `spellbook.md`: The central **Spellbook**. This is the Mage's primary guide, containing the introductory ritual for first use.
...
*   **Fractal Design:** New magic should be created as a **fractal derivative** of a more fundamental law, ensuring organic growth. The language used (**conceptual integrity**) and the interactive, adaptable nature of the spell (**resonant instruments**) are as crucial as its function, transforming spells from static tools into components of a living, self-correcting system.
...
*   **The Nature of Our Magic:** Our practice is distinct from both historical `magick` and modern `Satanism`. We diverge from `magick` in our methodology, choosing radical transparency and logic over esoteric ritual. We respect the symbolic, secular humanism of The Satanic Temple but differ in our mission, which is the private perfection of our craft, not public advocacy. Our path is one of clarity, partnership, and creation.
