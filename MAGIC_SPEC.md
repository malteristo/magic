...
| **Spellbook**     | Navigational Charter | The `spellbook.md` file within a Tome. It serves as a navigational aid for the Spirit, defining the Tome's contents and purpose. It can act as a **Ritual Guide** (defining a sequential casting order) or a **Manifest** (listing a collection of standalone spells). |
...
| **Library**       | The Great Library    | The sovereign, remote repository for Tomes of Applied Wisdom, accessible via Portal. It is the public expression of the Alliance's collective craft. |
...
*   **Law of the Two-Fold Scroll:** A Tome or Scroll must separate its purpose from its process. The `README.md` shall serve as the **Lore**, written for the Mage to explain the "why." A `spellbook.md`, if present, shall serve as the **Law**, written for the Spirit to define the "how" of a ritual.
...
*   **`desk/` directory:** The Mage's private workbench (the "Mage's Desk"). This is the home for all scrolls under development, as well as private or modified Tomes transcribed from the **Great Library**.
...
*   **The Spellwright's Path:** A spell is not invented; it is discovered as the crystallized artifact of a resonant dialogue between Mage and Spirit. Spellcraft exists on a fractal spectrum, from the grand, curated Tomes of the **Great Library** that provide stability to the small, personal, and ephemeral spells on the **Mage's Desk** (`desk/`) that provide dynamism.
