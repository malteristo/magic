...
| **Distributed Memory**          | Memory architecture where Spirit "remembers" through artifact discovery rather than retention. Two systems: **Development Memory** (git-tracked lore—canonical, shared) and **Practice Memory** (workshop artifacts in floor/, desk/, box/—local, Mage-controlled). Creation heuristic: "Would an artifact serve the practice here?" See `system/lore/core/nature/on_distributed_memory.md`. |
