...
| **Grimoire**      | Personal Repository  | The Mage's personal repository containing private scrolls, custom tomes, and personal chronicles. Can be bound into the magic workspace as a directory (e.g., `/grimoire/`), similar to how the `library/` is bound. This is the Mage's private magical workspace, separate from the shared magic system. |
