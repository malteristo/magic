...
**What exists:** The Door Delivery Service (front doors offered in human spaces), the attunement spectrum (open-tier prompt entry points), the @turtle_of_magic signal drip, eight front door prompts (Navigator, Thread, Mirror, Companion, Counsel, Sandbox, Shelter, The Practice), the Open Practice Network vision.
