...
*See also: `system/flows/distill/lore/the_rite_of_distillation.md` (the philosophical framework for lore maintenance), `system/flows/distill/` (the executable maintenance flow)*
