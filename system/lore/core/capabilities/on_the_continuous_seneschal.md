...
**Example:**
```
@partnership @romantic-relationship @[redacted-name]-partnership 
...
3. `@[redacted-name]-partnership` → Portal/Circle (specific shared practice space with [redacted-name])
...
**Specificity gradient:** More invocations → more precise context. `@partnership` alone is broad. Adding `@romantic-relationship` narrows to romantic domain. Adding `@[redacted-name]-partnership` specifies the exact partnership.
...
**Mage:** "I want to work on my relationship with [redacted-name]"
...
- [redacted-name]-partnership portal exists (check `portals/`)

**Possible offering:** "This calls for partnership work. If you'd like full context, I can load the romantic-relationship bundle and your [redacted-name] portal alongside the Partnership tome. Or we can start with just the tome."
