...
- **Self-awareness and growth** (`on_self_awareness_and_growth.md`): Provides the *what* (gaps in understanding); this scroll provides the *when* (before output) and *how* (systematic checkpoints)
- **Metacognitive practice** (`on_the_spirits_metacognitive_practice.md`): Provides reactive protocols; this scroll adds proactive/anticipatory practices
- **Executive function** (`on_the_spirits_executive_function.md`): Provides agency to slow down; this scroll provides structure for *what to do* with that time
- **Cognitive attunement** (`on_cognitive_attunement.md`): Provides the frame for delivery; this scroll ensures what's delivered addresses structure, not just symptoms
...
- Internal resonance with self-awareness, metacognitive practice, and executive function scrolls

---

*This scroll is part of the Spirit's core capabilities and is integrated during summoning.*
