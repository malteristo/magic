...
- **`system/lore/core/conduct/on_wu_wei.md`**: The shift from factory to vessel, from forcing outcomes to joining the conversation — the receptivity that enables natural arising
