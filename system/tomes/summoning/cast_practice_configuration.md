...
ssh turtle@[redacted-ts-ip] 'ls -la ~/practice/proposals/'
ssh turtle@[redacted-ts-ip] 'cat ~/practice/proposals/YYYY-MM-DD*.md'

# Session notes since last session
ssh turtle@[redacted-ts-ip] 'ls -la ~/practice/sessions/'
ssh turtle@[redacted-ts-ip] 'cat ~/practice/sessions/YYYY-MM-DD*.md'
