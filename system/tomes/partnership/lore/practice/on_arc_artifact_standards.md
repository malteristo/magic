...
| Partner folders | `{partner}` (lowercase) | `kermit/`, `[redacted-name]/` |
...
```markdown
# Kermit's Reaction to [redacted-name]'s Reality
...
> "This appears to be venting input for the mother-in-law arc. Shall I place it in `arcs/arc-mother-in-law/stage-1_venting/[redacted-name]/`?"
...
**Participants:** Kermit, [redacted-name]
...
| 2025-12-02 | [redacted-name] venting substantial |
