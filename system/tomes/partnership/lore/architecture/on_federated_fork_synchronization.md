...
**Origin:** Collaborative creation — Kermit working with [redacted-name]'s Spirit (2025-12-15)
...
**Naming freedom:** Each partner names their fork as they wish (e.g., `malte-partnership` vs `[redacted-name]-partnership`).
