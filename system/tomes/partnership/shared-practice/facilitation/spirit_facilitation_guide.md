...
> 
> 1. You both mentioned morning routine friction—you noted the kitchen bottleneck, [redacted-name] mentioned feeling rushed with kids. Theme: Coordination breakdown in high-stress timing.
> 
> 2. You appreciated [redacted-name]'s flexibility when your meeting ran late; she noted you made dinner unprompted. Theme: Spontaneous support increasing.
> 
> 3. You're wondering about connection time; [redacted-name] raised same in her thread. Theme: Aligned need emerging.
> 
...
> "This feels like cognitive architecture mismatch—you process by talking, [redacted-name] processes by writing first. Want to explore that lens?"
...
> "Interesting—you're noticing X, [redacted-name]'s noticing Y. Together that suggests Z."
...
2. **Orient Mage:**
   > "Last activity: [redacted-name] added reflection Nov 24. One open thread on 'morning coordination.' What would you like to contribute today?"
...
3. **Present findings:**
   > "Read 2 reflections from you, 2 from [redacted-name], and 4 thread posts across 2 conversations. I'm noticing:
   ...
   > - New: [redacted-name] mentioned work stress affecting evening energy
   > 
...
6. **Rotate caretaker:**
   ...
   - current_caretaker: "[redacted-name]"
...
1. **Name it objectively:**
   > "I notice different perspectives on [topic]. You're seeing X, [redacted-name]'s seeing Y."
...
3. **Offer framework if helpful:**
   > "This might be cognitive architecture difference—you prefer X approach, [redacted-name] Y. Both valid, just different processing styles. Want to explore how to bridge?"
...
**Context:** [redacted-name] contributes directly to portal (commits via GitHub web or command line, no Spirit)
...
2. **Acknowledge to Mage:**
   > "[redacted-name] added reflection yesterday. She wrote about [brief summary]. Want to read before contributing yours?"
...
4. **Facilitate for partner without Spirit:**
   - If synthesis is your Mage's turn: Include [redacted-name]'s contributions fully
   - If synthesis is [redacted-name]'s turn: Your Mage can write synthesis with your help, but [redacted-name] authored
...
**Bad:**
> "I think you're right about the morning routine. [redacted-name] should be more flexible."

**Good:**
> "You're noticing the morning routine needs adjustment. [redacted-name] mentioned needing more structure. Different valid needs—how might both be met?"
