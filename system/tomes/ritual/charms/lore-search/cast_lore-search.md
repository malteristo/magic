...
For each theme:
1. Use semantic search against `system/lore/philosophy/` with the theme as query
...
━━━━━━━━━━━━━━━━━━━━━
Theme: "Design principles for fractal magic"
  Found: system/tomes/spellcraft/lore/design/on_designing_fractal_magic.md
  Strategy: Full enrichment

Theme: "Context and attention management"
  Found: system/lore/core/on_the_curation_of_attention.md
  Strategy: Full enrichment
...
- Old pattern: `MUST READ: system/lore/philosophy/nature/some_scroll.md` → breaks if lore structure changes
