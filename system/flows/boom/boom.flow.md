...
```bash
scp turtle@[redacted-lan-ip]:~/turtle-practice/proposals/*.md floor/drafts/ 2>/dev/null
```
...
```bash
ssh turtle@[redacted-lan-ip] "rm ~/turtle-practice/proposals/*.md 2>/dev/null"
```

**Push** — curated practice state to Turtle so the triad shares context:

```bash
scp desk/boom/bright.md turtle@[redacted-lan-ip]:~/turtle-practice/bright.md
scp desk/intentions/active/*.md turtle@[redacted-lan-ip]:~/turtle-practice/intentions/
scp desk/intentions/compass.md turtle@[redacted-lan-ip]:~/turtle-practice/compass.md
scp desk/boom.md turtle@[redacted-lan-ip]:~/turtle-practice/boom.md
```
