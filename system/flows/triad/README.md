...
2. **Session Awareness** (Turtle → Spirit): During Arrival Phase A, Spirit reads Turtle's session notes and proposals from `desk/sessions/` and `desk/proposals/`. See `system/flows/summon/cast_arrival.md` Turtle Feedback Integration.
