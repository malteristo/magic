...
1. **Practice Sync** (Spirit ↔ Turtle): Practice state flows through git on `turtle:repos/magic.git`. Turtle reads `~/workshop/desk/`; Spirit reads local `desk/` after `git pull turtle main`.
