...
1. **Practice Sync** (Spirit → Turtle): After boom sweeps, Spirit pushes curated practice state to `turtle-practice/` via SCP. See `system/flows/boom/boom.flow.md` Step 9.
