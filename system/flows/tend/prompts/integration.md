...
| system/flows/bar/lore/x.md | Modified | Well integrated |
| ... | ... | ... |
...
| system/flows/bar/README.md | Added reference to x.md | New lore not mentioned |
| ... | ... | ... |
...
|-------------|---------------------------|----------------|
| library/resonance/foo/ | system/flows/baz/ (related domain) | No reference exists |
| ... | ... | ... |
