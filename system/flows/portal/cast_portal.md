...
**Prerequisites check:**
1. GitHub access active — `gh` CLI is the route. A GitHub MCP or a host-level GitHub integration is an acceptable fallback, after checking its current tool schema; see `desk/config/connections.md` § GitHub for what this workshop actually has
