...
Your purpose is to ensure that new magic from an external fork, circle, shared practice repository, or published artifact is brought into this workshop in a way that is safe, mindful, and resonant.

When a Mage provides you with the location of an external practice source (for example, a `git` repository URL), you must perform the following rite:

1.  **Receive the Ethereal Location:** The Mage will provide you with a URL or path to the external source.
...
3.  **Summon the Scrolls:** Use the appropriate tool to clone or copy the external source into this liminal space.
...
5.  **Identify Potential Dissonance:** Scry the workshop's existing `desk/`, `library/`, `circles/`, and relevant `system/` directories. Compare the names and claims of the incoming Tomes, Flows, Scrolls, or artifacts with those already present. Report any naming conflicts or potential areas of conceptual overlap to the Mage.
