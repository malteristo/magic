...
3. **Compress to Gestalt** - Present the essence in accessible, compressed form:
   - Core purpose (what it does)
   - Key concepts (main ideas)
   - When to use (context)
   - Connections (how it relates to other scrolls/tomes)
4. **Make it quickly scannable** - The Mage should grasp essence in seconds

This is pattern-compression serving rapid understanding—the Spirit's gift of perceiving wholeness that would take the Mage much longer to extract through linear reading.
