...
3.  **Report & Reassure:**
    ...
    - **Portal awareness:** `portals/portals.yaml` and `portals/README.md` ARE tracked (portal infrastructure), but portal subdirectories (external repos) are gitignored and untouched.
