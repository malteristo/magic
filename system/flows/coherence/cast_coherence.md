...
- `system/flows/` — Required directories exist? (`system/tomes/` holds only the deep-summoning archive + pointer map)
...
**Scope options:**
- All flows in `system/flows/` (+ the summoning archive in `system/tomes/summoning/`)
- Specific flow only
- Recently modified flows
...
**system/flows/tend/:** ✓ Coherent  
**system/flows/partnership/:** ⚠ 1 issue
