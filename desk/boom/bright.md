# Bright Surface
> Last swept: 2026-04-20 (Anvil — Monday quick-Sunday triage + craft cycle, then continuation cycle. Founding-member front door idea + substrate-literacy conversation routed; substrate literacy + productive irresolution crystallized as foundational lore; founding-member front door scaffolded at `floor/drafts/founding_member_front_door.md`; **founder-flows pattern recognized and scaffolded at `floor/drafts/founder_flows_pattern.md` — front door reframed as its first instance, Phase G structured-return added**.)
